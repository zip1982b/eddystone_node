...
#define EDDYSTONE_SENDER	0
#define EDDYSTONE_RECEIVER	1
#define EDDYSTONE_MODE CONFIG_EDDYSTONE_MODE

//#define EDDYSTONE_MODE 0 

#define EDDYSTONE_UID_FRAME 3
#define EDDYSTONE_URL_FRAME 4
#define EDDYSTONE_TLM_FRAME 5

#define EDDYSTONE_FRAME_TYPE 5
