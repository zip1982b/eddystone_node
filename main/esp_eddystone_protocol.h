...
#define EDDYSTONE_FRAME_TYPE_LEN	1
...
#define EDDYSTONE_UID_DATA_LEN         (EDDYSTONE_FRAME_TYPE_LEN + EDDYSTONE_UID_RANG_DATA_LEN + EDDYSTONE_UID_NAMESPACE_LEN + EDDYSTONE_UID_INSTANCE_LEN + EDDYSTONE_UID_RFU_LEN)
//TLM
...
#define EDDYSTONE_TLM_DATA_LEN             (EDDYSTONE_FRAME_TYPE_LEN + EDDYSTONE_TLM_VERSION_LEN + EDDYSTONE_TLM_BATTERY_VOLTAGE_LEN + EDDYSTONE_TLM_TEMPERATURE_LEN + EDDYSTONE_TLM_ADV_COUNT_LEN + EDDYSTONE_TLM_TIME_LEN)
//URL
#define EDDYSTONE_URL_SCHEME_LEN        1
#define EDDYSTONE_URL_ENCODED_MAX_LEN   17
#define EDDYSTONE_URL_MAX_LEN           (EDDYSTONE_FRAME_TYPE_LEN +EDDYSTONE_URL_TX_POWER_LEN + EDDYSTONE_URL_SCHEME_LEN + EDDYSTONE_URL_ENCODED_MAX_LEN)
